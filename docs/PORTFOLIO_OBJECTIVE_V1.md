...
## 2. Bruto, líquido e unidade de medição

O alvo central preserva a decisão anterior de acompanhar o retorno bruto da
estratégia, mas todo estudo deve publicar as duas visões:

```text
retorno_bruto_por_contrato_mes = PnL bruto / contratos executados
retorno_liquido_por_contrato_mes = PnL após custos, slippage e execução / contratos executados
```

O retorno líquido é obrigatório para promoção operacional. Uma estratégia não
pode ser promovida apenas porque alcançou R$ 1.000 bruto se custos, slippage,
liquidez ou execução eliminarem a vantagem.
...
- PnL bruto e líquido por mês e por contrato;
...
- custos, slippage, rejeições e capacidade estimada;
- comparação com cada estratégia isolada.

Uma estratégia não entra no portfólio apenas por ter maior PnL. Ela precisa
contribuir com retorno líquido ou reduzir risco, instabilidade ou concentração.
...
Cada política deve preservar a sequência tick a tick, o preço possível, a
quantidade restante, custos e slippage. Não será aceito um backtest que use o
...
2. calcular o modelo de custos e slippage por ativo e horário;
3. testar a capacidade de 10 WDO e 50 WIN sem assumir liquidez infinita;
4. executar hipóteses de entrada com políticas de saída versionadas;
5. formar portfólios por ativo e medir contribuição marginal;
6. abrir o holdout somente após configuração congelada e aprovação do gate.
